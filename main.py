...
print(f"The interpolated value of f(1.6) is {y_interpolated:.4f}")
...
print(f"The interpolated value of y at x = {x2_to_interpolate} is {interpolated_value:.2f}")
...
print(f"The interpolated value of u(3) is {interpolated_value:.2f}")